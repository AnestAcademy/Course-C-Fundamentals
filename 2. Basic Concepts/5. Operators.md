...
| Định dạng  | Phép toán | 
| :--------: | -------- |
| `+`        | Phép cộng - addition or unary plus |
| `-`        | Phép trừ - subtraction or unary minus |
| `*`        | Phép nhân - multiplication |
| `/`        | Phép chia - division |
| `%`        | Phép chia lấy dư - remainder after division (modulo division) |
...
Các bạn hãy chuyển sang đọc riêng một bài về vấn đề này tại đây [Type Conversion](https://github.com/AnestLearning/Course-C-Fundamentals/blob/master/2.%20Basic%20Concepts/6.%20Type%20Conversion.md).
