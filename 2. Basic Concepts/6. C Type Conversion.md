...
### Chúng ta có thể chuyển dữ kiệu nhỏ sang kiểu dữ liệu lớn hơn nên vì vậy cũng có thể chuyển dữ kiệu lớn hơn sang kiểu dữ liệu nhỏ hơn - nhưng điều này có những vấn đề quan trọng cần lưu ý sau:
