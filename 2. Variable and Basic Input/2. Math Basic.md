...
int main() {
  ...
  int result = 0; // xác định được kết quả là số nguyên nên khai báo kiểu dữ liệu cho result là int
  result = 8 / 4;
...
int main() {
  ...
  float result = 0; // xác định được kết quả là số thập phân nên khai báo kiểu dữ liệu cho result là float
  result = 5 / 2;
