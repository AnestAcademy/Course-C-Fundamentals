...
Lưu ý khi khai báo và gán giá trị cho kiểu số thập phân, trong lập trình chúng ta sẽ sử dụng dấu chấm `.` thay vì dấu phẩy `,` - mặc dù khi nói hay viết chúng ta vẫn hay sử dụng cụm từ `dấu phẩy động` để ám chỉ các số thập phân.
