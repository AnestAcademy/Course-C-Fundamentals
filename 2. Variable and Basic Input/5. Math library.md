...
Hàm này sẽ **trả về giá trị dạng số nguyên** nếu như ta đưa cho nó một số thực. Hay chúng ta còn gọi là làm tròn số, nhưng hàm `ceil` sẽ luôn làm tròn lên (tăng giá trị).
