...
> Đoạn `2 → 3.464` có ước bằng 2, tương ứng đoạn `3.464 → 12` có ước bằng 6     // 2 * 6 = 12 
> Đoạn `2 → 3.464` có ước bằng 3, tương ứng đoạn `3.464 → 12` có ước bằng 4     // 3 * 4 = 12  
> Trong đoạn `2 → 3.464` số 12 chia hết cho 2 số (2, 3) → 12 không phải là số nguyên tố.
 
> Với số 9, ta có sqrt(9) = 3  
> Đoạn `2 → 3` có ước 3, tương ứng đoạn `3 → 9` có ước 3     // 3*3 = 9  
