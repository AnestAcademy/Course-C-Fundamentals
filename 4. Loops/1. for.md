...
**`break`** - đầy là một từ khoá hay dùng đi với vòng lặp, để hiểu rõ về nó bạn hãy đọc bài viết tiếp theo [tại đây](https://github.com/AnestLearning/Course-C-Fundamentals/blob/master/4.%20Loops/5.%20break.md).
