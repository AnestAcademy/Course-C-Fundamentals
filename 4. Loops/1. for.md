...
> Đoạn `1 → 3.464` có ước bằng 1, tương ứng đoạn `3.464 → 12` có ước bằng 12    // 1 * 12 = 12
> Đoạn `1 → 3.464` có ước bằng 2, tương ứng đoạn `3.464 → 12` có ước bằng 6     // 2 * 6 = 12 
> Đoạn `1 → 3.464` có ước bằng 3, tương ứng đoạn `3.464 → 12` có ước bằng 4     // 3 * 4 = 12
